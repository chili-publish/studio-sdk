...
import {
    ...
    ListVariable,
    Page,
    StylekitChacterStylesController,
    StylekitColorsController,
    StylekitParagraphStylesController,
    Variable,
    VariableValue,
// eslint-disable-next-line import/no-unresolved
} from 'grafx-studio-actions';
...
export function copyStylekitItem(
    stylekit: StylekitChacterStylesController | StylekitParagraphStylesController | StylekitColorsController,
    from: string | IHasName,
    to: string | IHasName,
) {
    let fromName = from;
    let toName = to;
...
export class FrameNotFoundError extends Error {
    constructor(name: string) {
        const names = studio.layouts
            ...
            .join(', ');
        super(
            'Frame with name ' + name + ' was not found.\nThis function expects any of the following values:\n' + names,
        );
        this.name = this.constructor.name;
    }
}
