...
export class FontController {
   ...
   */
  getPreviewsOfCharacterStrings = async (
    characters: string[],
    characterPreviewStyle: CharacterPreviewStyle
  ) => {
    const res = await this.#editorAPI;
    return res.getPreviewsOfCharacterStrings(characters, characterPreviewStyle).then((result) => getEditorResponseData<null>(result));
  };
}
