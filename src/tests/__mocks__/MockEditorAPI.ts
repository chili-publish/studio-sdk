...
export const mockSetFrameConstrainProportions = jest.fn().mockResolvedValue({ success: true, status: 0 });
...
const MockEditorAPI = {
    ...
    moveVariables: mockMoveVariables,
    ...
    setFrameConstrainProportions: mockSetFrameConstrainProportions,
